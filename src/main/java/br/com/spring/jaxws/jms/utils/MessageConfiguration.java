...
import br.com.spring.jaxws.jms.service.ReceivedMessageListenerService;
...
public class MessageConfiguration {
	...
	@Autowired
	private ReceivedMessageListenerService receivedMessageListenerService;
	...
	public JmsTemplate jmsTemplate() {
		...
		template.setDefaultDestinationName(MessageConstants.MESSAGE_TOPIC);
	...
	public DefaultMessageListenerContainer receivedMessageListenerContainer() {
		...
		defaultMessageListenerContainer.setDestinationName(MessageConstants.MESSAGE_TOPIC);
		defaultMessageListenerContainer.setMessageListener(receivedMessageListenerService);
